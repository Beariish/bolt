...
void boltstd_open_strings(bt_Context* context)
{
	...
	bt_Type* length_sig = bt_make_method_type(context, number, &string, 1);
	...
	bt_Type* substring_sig = bt_make_method_type(context, string, substring_args, 3);
	...
	bt_Type* remainder_sig = bt_make_method_type(context, string, remainder_args, 2);
	...
	bt_Type* concat_sig = bt_make_signature_vararg(context, bt_make_method_type(context, string, &string, 1), string);
	...
	bt_Type* format_sig = bt_make_signature_vararg(context, bt_make_method_type(context, string, &string, 1), any);
	...
	bt_Type* find_sig = bt_make_method_type(context, number, find_args, 2);
	...
	bt_Type* replace_sig = bt_make_method_type(context, string, replace_args, 3);
	...
	bt_Type* reverse_sig = bt_make_method_type(context, string, &string, 1);
	...
	bt_Type* byte_at_sig = bt_make_method_type(context, number, byte_at_args, 2);
	...
	bt_Type* from_byte_sig = bt_make_method_type(context, string, &number, 1);
	...
	bt_Type* x_with_sig = bt_make_method_type(context, boolean, find_args, 2);
	...
	bt_Type* compare_at_sig = bt_make_method_type(context, boolean, compare_at_args, 3);
